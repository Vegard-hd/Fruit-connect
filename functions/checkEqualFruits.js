module.exports = {
   ...
   */
  findConnectedFruits(gameFruitArr, startIndex, width = 10, height = 12) {
   ...
   */
  removeAndShiftFruits(gameFruitArr, indicesToRemove, randomFruit) {
    ...
    for (const index of sortedIndices) {
      ...
      for (let i = index; i > rowStart; i--) {
        console.log("inside removeAndShiftFruits function");
